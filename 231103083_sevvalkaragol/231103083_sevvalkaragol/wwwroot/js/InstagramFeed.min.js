...
(function (a, b) {
    ...
    (this, function () {
        ...
        var b = { host: "https://www.instagram.com/", username: "", tag: "", container: "", display_profile: !0, display_biography: !0, display_gallery: !0, display_igtv: !1, callback: null, styling: !0, items: 8, items_per_row: 4, margin: .5, image_size: 640, lazy_load: !1, on_error: console.error }, c = { 150: 0, 240: 1, 320: 2, 480: 3, 640: 4 }, d = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "/": "&#x2F;", "`": "&#x60;", "=": "&#x3D;" };
        return function (d) {
            this.options = Object.assign({}, b), this.options = Object.assign(this.options, d), this.is_tag = "" == this.options.username, this.valid = !0, "" == this.options.username && "" == this.options.tag && (this.options.on_error("InstagramFeed: Error, no username or tag defined.", 1), this.valid = !1), "undefined" != typeof this.options.get_data && console.warn("InstagramFeed: options.get_data is deprecated, options.callback is always called if defined"), null == this.options.callback && "" == this.options.container && (this.options.on_error("InstagramFeed: Error, neither container found nor callback defined.", 2), this.valid = !1), this.get = function (a) {
                var b = this.is_tag ? this.options.host + "explore/tags/" + this.options.tag + "/" : this.options.host + this.options.username + "/", c = new XMLHttpRequest, d = this; c.onload = function () {
                    if (4 === c.readyState) if (200 === c.status) {
                        try { var b = c.responseText.split("window._sharedData = ")[1].split("</script>")[0] } catch (a) { return void d.options.on_error("InstagramFeed: It looks like the profile you are trying to fetch is age restricted. See https://github.com/jsanahuja/InstagramFeed/issues/26", 3) } if (b = JSON.parse(b.substr(0, b.length - 1)), b = b.entry_data.ProfilePage || b.entry_data.TagPage, "undefined" == typeof b)
                            return void d.options.on_error("InstagramFeed: It looks like YOUR network has been temporary banned because of too many requests. See https://github.com/jsanahuja/jquery.instagramFeed/issues/25", 4); b = b[0].graphql.user || b[0].graphql.hashtag, a(b, d)
                ...
                if (this.options.styling)
                    var d = (100 - 2 * this.options.margin * this.options.items_per_row) / this.options.items_per_row,
                        e = {
                            ...
                            profile_image: " style='border-radius:10em;width:15%;max-width:125px;min-width:50px;'", profile_name: " style='font-size:1.2em;'", profile_biography: " style='font-size:1em;'", gallery_image: " style='margin:" + this.options.margin + "% " + this.options.margin + "%;width:" + d + "%;float:left;'"
                        }; else var e = {
                            profile_container: "",
                            profile_image: "",
                            profile_name: "",
                ...
                if (this.options.display_profile && (
                    ...
                    f += "<img class='instagram_profile_image'" + (this.options.lazy_load ? " loading='lazy'" : "") + " src='" + b.profile_pic_url + "' alt='" + (this.is_tag ? b.name + " tag pic" : b.username + " profile pic") + " profile pic'" + e.profile_image + " />",
                    ...
                    f += "</div>"), this.options.display_gallery) {
                        ...
                        for (var j = 0; j < p; j++)
                        {
                            var k, l, m = "https://www.instagram.com/p/" + h[j].node.shortcode,
                                ...
                                switch (h[j].node.__typename) {
                                    case "GraphSidecar": l = "sidecar",
                                        k = h[j].node.thumbnail_resources[g].src;
                                        break;
                                    case "GraphVideo": l = "video",
                                        k = h[j].node.thumbnail_src;
                                        break;
                                    default: l = "image",
                                        k = h[j].node.thumbnail_resources[g].src;
                                }
                            this.is_tag && (b.username = ""),
                                ...
                                f += "<img" + (this.options.lazy_load ? " loading='lazy'" : "") + "class='img-fluid' src='" + k + "' alt='" + n + "'" + e.gallery_image + " />",
                                f += "</a>"
                        }
                        f += "";
                    }
