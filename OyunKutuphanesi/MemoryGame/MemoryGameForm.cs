...
namespace OyunKutuphanesi.MemoryGame
{
    public partial class MemoryGameForm : Form
    {
        ...
        public MemoryGameForm(int kullaniciId)
        {
            InitializeComponent();
        ...
        private void OyunBitti()
        {
            ...
            {
                string sorgu = @"INSERT INTO MemoryGameSkorlar (KullaniciID, Skor, ZorlukSeviyesi, OyunSuresi, EslesmeSayisi, OyunTarihi) 
